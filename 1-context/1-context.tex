...
Or, dans les enjeux de la gestion de crise on a vu qu'on a besoin de donnees et d'informations pour pouvoir atteindre nos objectifs.
Les medias sociaux apparaissent donc comme une source d'information potentielle pour les services d'urgences.
De plus, là où les appels telephoniques étaient l'unique lien avec la population, ce double numerique de la societe offre désormais une nouvelle une porte d'entree, en temps reel, des conversations et du ressenti des personnes témoins de l'événement.
Ces plateformes rendent ainsi disponibles une grande variete de donnees, qui peuvent aider les services d'urgence \cite{tapiaSeekingTrustworthyTweet2011a}.
En tant que plateformes de creation de contenu, les utilisateurs disposent d'un large éventail d'outils à leur disposition pour partager des messages textuels, des photos ou des videos.
Ces differents types de contenu peuvent permettre aux preneurs de decision des cellules de crise de prendre conscience de l'ampleur de l'evenement, meme à des endroits ou ils n'ont personne de deployes.
Les medias sociaux peuvent egalement rapporter des informations qui auraient pu etre non communiques par d'autres acteurs au sein de l'organisation.
Enfin, les utilisateurs de ces plateformes non impactees directement par l'evenement peuvent décider de venir en aide aux victimes.
Ces volontaires, numeriques ou non, pourraient être mobilisés pour porter assistance aux personnel de secours deployes sur le lieux de l'événement \cite{batardIntegrerContributionsCitoyennes2021}.
...
\cite{farzindarNaturalLanguageProcessing2017} identify several applications of NLP for social media
