...
\begin{center}
    \fbox{
        \begin{minipage}{0.75\textwidth}
            ...
            What kind of relevant information can be obtained from social media?
        \end{minipage}
    }
\end{center}
...
\begin{figure}
    \centering
    \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio, angle=90]{figures/big-picture.pdf}
